...
export default function Post({idol, post}) {
  const idolCtaDestination = `https://ivysoulmate.com/idol/${idol.slug}?c=seo&s=satellite&utm_source=satellite&utm_medium=onlyfan-leak&utm_campaign=seo-satellite`;
  const nsfwVersionCta = (
    <div className="fixed top-4 flex justify-center w-full">
      <a href={idolCtaDestination} className="cta flex items-center justify-center gap-2 bg-gray-950/40 px-4 py-2 rounded-full text-sm backdrop-blur-md">
    ...
    <div className="border-b border-zinc-800/80">
      <div className="flex w-full flex-col gap-3 border-b border-gray-800">
        <div className="flex w-full items-center gap-2 px-4 pt-4">
          <a href={idolCtaDestination} className="w-fit cta">
          ...
          <div className="flex w-full items-center justify-between">
            <div>
              <div>
                <a href={idolCtaDestination} className="w-fit cta">
                  <span className="w-fit font-semibold text-gray-200">{idol.display_name}</span></a>&nbsp;&nbsp;•&nbsp;&nbsp;<a href={idolCtaDestination} className="cta font-medium no-underline text-sky-500">Follow
                </a>
              </div>
            ...
            <div>
              <a href={idolCtaDestination} className="cta flex w-full items-center justify-center gap-2 rounded-xl font-bold text-sm text-sky-50 bg-sky-500 px-4 py-2">
          ...
          <Swiper
            ...
            <SwiperSlide>
              ...
              <div className="fixed top-0 left-0 h-full w-full flex-col items-center gap-6 bg-gray-950/40 backdrop-blur-sm px-6 py-4 text-center place-content-center">
                ...
                <a href={idolCtaDestination} className="cta text-sky-50 no-underline bg-sky-400 rounded-full font-semibold text-sm px-4 py-2 mt-4">
        ...
        <div className="flex items-center justify-between gap-6 px-4 pb-4">
          <div className="flex items-center gap-6">
            <div className="flex w-fit items-center gap-1">
              <a href={idolCtaDestination} className="cta text-2xl text-sky-500 transition-transform duration-300" tabIndex="0">
            ...
            <a href={idolCtaDestination} className="cta flex items-center gap-2 text-primary" tabIndex="0">
          ...
          <div className="flex items-center">
            <a href={idolCtaDestination} className="cta text-2xl" tabIndex="0">
              <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
