...
export async function generateMetadata({ params }) {
  ...
  if (idol) {
    ...
    return {
      title: "Ivy Soulmate - #1 Advanced AI Girlfriend",
      ...
      openGraph: {
        siteName: "Ivy Soulmate - #1 Advanced AI Girlfriend",
        title: "Ivy Soulmate - #1 Advanced AI Girlfriend",
        description: "Hot Idols are waiting to get intimate with you. Anytime! Visualize Your Fantasies, Daily Hot Photos & Videos, Curated Scenarios, Roleplay Chat",
...
export default async function Home({ params, searchParams }) {
  ...
  const idolCtaDestination = `https://ivysoulmate.com/idol/${slug}?c=seo&s=satellite&utm_source=satellite&utm_medium=onlyfan-leak&utm_campaign=seo-satellite`;
  const ivyCtaDestination = `https://ivysoulmate.com?c=seo&s=satellite&utm_source=satellite&utm_medium=onlyfan-leak&utm_campaign=seo-satellite`;
    ...
    <>
      ...
      <div className="flex flex-col bg-zinc-950 min-h-screen">
              ...
              <div className="relative z-0 flex flex-col gap-4 p-4">
                ...
                <div className="flex w-full items-center gap-2">
                  <div className="w-full">
                    <a href={idolCtaDestination} className="cta bg-sky-500 py-3 rounded-lg items-center justify-center font-semibold text-sm flex w-full gap-2 text-white">
                  ...
                  <div className="w-full">
                    <a href={idolCtaDestination} className="cta border border-sky-500 text-sky-500 py-3 rounded-lg items-center justify-center font-semibold text-sm flex w-full gap-2">
                      <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="text-xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href={idolCtaDestination} className="cta border border-sky-500 text-sky-500 p-3 self-stretch rounded-lg items-center justify-center font-semibold text-xl">
              ...
              <div id="highlights-wrapper">
                <div className="flex items-center gap-3 overflow-x-auto px-4 pb-6 pt-3">
                  {highlights.map((highlight, index) => {
                    ...
                    return (
                      <a href={idolCtaDestination} className="cta" key={index}>
        ...
        <footer className="flex justify-center">
          <div className="w-full max-w-screen-md bg-gray-950">
            <div className="px-4 py-8">
              <div className="h-10 flex items-center gap-2 mb-4">
                <img alt="logo" loading="lazy" decoding="async" data-nimg="1" className="h-full object-contain" src="logo.png" />
                <span className="font-bold text-lg">OnlyFans Leaks Daily</span>
              </div>
              <div className="flex flex-row justify-between">
                ...
                <div className="w-1/2 flex flex-col gap-2">
                  ...
                  <a href={idolCtaDestination} className="cta font-semibold">AI Girlfriend</a>
                  <a href="https://ivysoulmate.com/explore-ai-girlfriends?c=seo&s=satellite&utm_source=satellite&utm_medium=onlyfan-leak&utm_campaign=seo-satellite" className="cta font-semibold">AI Sexting</a>
                  <a href="https://ivysoulmate.com/en/create-ai-girlfriend?c=seo&s=satellite&utm_source=satellite&utm_medium=onlyfan-leak&utm_campaign=seo-satellite" className="cta font-semibold">Create Girlfriend</a>
                  <p className="font-semibold text-sm text-gray-400 mt-4">Legal</p>
                  <a href="https://ivysoulmate.com/terms-of-service?c=seo&s=satellite&utm_source=satellite&utm_medium=onlyfan-leak&utm_campaign=seo-satellite" className="cta font-semibold">Terms of Service</a>
                  <a href="https://ivysoulmate.com/privacy-policy?c=seo&s=satellite&utm_source=satellite&utm_medium=onlyfan-leak&utm_campaign=seo-satellite" className="cta font-semibold">Privacy Policy</a>
                  <a href="https://ivysoulmate.com/affiliate-policy?c=seo&s=satellite&utm_source=satellite&utm_medium=onlyfan-leak&utm_campaign=seo-satellite" className="cta font-semibold">Affiliate Policy</a>
                </div>
              </div>
            </div>
          </div>
