              ...
              <div className="relative z-0 flex flex-col gap-4 p-4">
                ...
                <div className="flex w-full items-center gap-2">
                  <div className="w-full">
                    <a href="https://ivysoulmate.com" className="cta bg-rose-500 py-3 rounded-lg items-center justify-center font-semibold text-sm flex w-full gap-2 text-white">
                  ...
                  <div className="w-full">
                    <a href="https://ivysoulmate.com" className="cta border border-rose-500 text-rose-500 py-3 rounded-lg items-center justify-center font-semibold text-sm flex w-full gap-2">
                      <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" className="text-xl" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a href="https://ivysoulmate.com" className="cta border border-rose-500 text-rose-500 p-3 self-stretch rounded-lg items-center justify-center font-semibold text-xl">
